//ovc.catastro.meh.es/ovcservweb/OVCSWLocalizacionRC/OVCCallejero.asmx/Consulta_DNPRC?Provincia=&Municipio=&RC=42071A036260920000MO
...
func main() {
	menu :=
		`
		Bienvenido al programita para ver andesta una ref. catastral de una tierra agricola.
		Mete el numero de 14 o 20 posiciones. Ojo, no funciona con navarra y Pais Vasco.
	`
	fmt.Print(menu)
	fmt.Println(" ")
	fmt.Println("####################")
	...
	// http get
	varHtml := httpExampleGetJson(entrada)
